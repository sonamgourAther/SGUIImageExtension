#
# Be sure to run `pod lib lint SGUIImageExtension.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SGUIImageExtension'
  s.version          = '1.0.0'
  s.summary          = 'A short description of SGUIImageExtension.'
